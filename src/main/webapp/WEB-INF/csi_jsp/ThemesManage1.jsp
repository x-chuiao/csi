									...
									<div>
										<table cellspacing="0" cellpadding="4" id="GridView1" class="table table-bordered table-hover" style="color:#333333;width:100%;">
											...
											<tbody>
												...
												<td><input class="GridView1_ctl02_CheckBox1" type="checkbox" value="120" name="GridView1$ctl02$CheckBox1"></td>
												...
												<tr style="background-color:white;" class="GridView1_ctl02_rows">
												<td><input class="GridView1_ctl02_CheckBox1" type="checkbox" value="73" name="GridView1$ctl02$CheckBox1"></td>
												<td align="center">2</td>
												<td align="center">3</td>
												<td align="center">抽象方法必须在抽象类中，所以抽象类中的方法都必须是抽象方法。</td>
												...
												<tr style="background-color:white;" class="GridView1_ctl02_rows">
												<td><input class="GridView1_ctl02_CheckBox1" type="checkbox" value="69" name="GridView1$ctl02$CheckBox1"></td>
												<td align="center">3</td>
												<td align="center">3</td>
												<td align="center"> 对象可以赋值，只要使用赋值号（等号）即可，相当于生成了一个各属性与赋值对象相同的新对象。</td>
												<td align="center">对</td>
												<td align="center" style="width:50px;" class="paperState">
													已启用
												</td>
												...
												<tr style="background-color:white;" class="GridView1_ctl02_rows">
												<td><input class="GridView1_ctl02_CheckBox1" type="checkbox" value="70" name="GridView1$ctl02$CheckBox1"></td>
												<td align="center">4</td>
												<td align="center">3</td>
												<td align="center"> 有的类定义时可以不定义构造函数，所以构造函数不是必需的。</td>
												<td align="center">对</td>
												<td align="center" style="width:50px;" class="paperState">
													已启用
												</td>
												...
												<tr style="background-color:white;" class="GridView1_ctl02_rows">
												<td><input class="GridView1_ctl02_CheckBox1" type="checkbox" value="71" name="GridView1$ctl02$CheckBox1"></td>
												<td align="center">5</td>
												<td align="center">3</td>
												<td align="center">类及其属性、方法可以同时有一个以上的修饰符来修饰。</td>
												<td align="center">对</td>
												<td align="center" style="width:50px;" class="paperState">
													已启用
												</td>
	...
	<script src="http://apps.bdimg.com/libs/jquery/1.6.4/jquery.min.js"></script>
		<script type="text/javascript">
			...
			function deleteServlet() {
				...
				if (isChecked != 0) {
					if (confirm("是否确认作废")) {
						location.href="ThemesManage1.do";
					}
				}else{
					alert("请选择");
				}
